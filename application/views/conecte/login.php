...
<div class="main-login">
    ...
    <h1 class="h-one">Área do Cliente</h1>
            <img src="<?php echo base_url() ?>assets/img/forms-animate.svg"class="left-login-imagec" alt="O.S Online">
        </div>
                        ...
                        <div class="content">
                            <div id="newlog">
                              ...
                              <div class="control-group">
                                ...
                                <div class="links-uteis"><a href="https://jwinformatica.com.br"><p><?= date('Y'); ?> &copy; Wagner Elias</p></a></div>
                            </div>
                        </div>
                    </div>
                </div>
